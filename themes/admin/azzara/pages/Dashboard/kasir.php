...
<body>
        ...
        <div class="page-inner">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="card">
                <div class="card-header">
                  <div class="card-title">Penjualan Anda</div>
                </div>
                <div class="card-body p-1">
                  <div class="chart-container">
                    <canvas id="pendapatan-harian-kasir"></canvas>
                  </div>
                  <div id="myChartLegend">
                    <ul class="0-legend html-legend">
                      <li class=""><span style="background-color:#005ba0"></span>Bulan : <b><?= rupiah(array_sum(array_column($chart_pendapatan_harian, "bulan_ini_kasir"))); ?></b></li>
                      <li class=""><span style="background-color:#1ba000"></span>Bulan Kemarin: <b><?= rupiah(array_sum(array_column($chart_pendapatan_harian, "bulan_kemarin_kasir"))); ?></b></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-header">
                  <div class="card-title">Total Penjualan Semua Kasir</div>
                </div>
                <div class="card-body p-1">
                  <div class="chart-container">
  ...
  <script>
    ...
    let barPendapatanKasir = document.getElementById('pendapatan-harian-kasir').getContext('2d');
    ...
    let myBarPendapatan = new Chart(barPendapatan, {
      ...
      data: {
        ...
        datasets: [{
          ...
          label: "Bulan Lalu",
          borderColor: '#fdaf4b',
          pointBackgroundColor: 'rgba(27, 160, 0, 0.638)',
          pointRadius: 0,
    ...
    let myBarPendapatanKasir = new Chart(barPendapatanKasir, {
      type: 'line',
      data: {
        labels: pendapatan_harian.map(view => view.day),
        datasets: [{
          label: "Bulan Ini",
          borderColor: '#005ba0',
          pointBackgroundColor: 'rgba(0, 91, 160, 0.433)',
          pointRadius: 0,
          backgroundColor: 'rgba(0, 91, 160, 0.433)',
          legendColor: '#005ba0',
          fill: true,
          borderWidth: 2,
          data: pendapatan_harian.map(view => view.bulan_ini_kasir),
        }, {
          label: "Bulan Lalu",
          borderColor: '#1ba000',
          pointBackgroundColor: 'rgba(27, 160, 0, 0.433)',
          pointRadius: 0,
          backgroundColor: 'rgba(27, 160, 0, 0.433)',
          legendColor: '#1ba000',
          fill: true,
          borderWidth: 2,
          data: pendapatan_harian.map(view => view.bulan_kemarin_kasir),
        }, ],
      },
      options: {
        responsive: true,
