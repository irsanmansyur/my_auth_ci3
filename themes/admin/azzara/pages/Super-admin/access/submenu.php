...
<body>
            ...
            <div class="page-inner">
               <div class="page-header">
                  ...
                  <ul class="breadcrumbs">
                     ...
                     <li class="nav-item">
                        <a href=<?= base_url('super-admin/access'); ?>>Access Users</a>
                     </li>
                     <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                     </li>
   ...
   <script>
      ...
      let elSubmenu = document.querySelector('[name="submenu_id"]');
      [...elRules].forEach(elRule => {
         elRule.addEventListener("change", () => {
            let isSelect = elRule.checked;
            swal({
               title: 'Are you sure?',
               text: `this Rules will ${isSelect? "has ":' Not'} access the submenu!`,
               type: 'warning',
               buttons: {
                  cancel: {
                     visible: true,
               ...
               if (willChange) {
                  let ress;
                  if (!isSelect)
                     ress = await deleteData(baseUrl + `api/access/submenu/${elSubmenu.value}/${elRule.value}`);
                  else ress = await postData(baseUrl + `api/access/submenu`, {
                     submenu_id: elSubmenu.value,
