            ...
            <div class="page-inner">
               <div class="page-header">
                  ...
                  <ul class="breadcrumbs">
                     ...
                     <li class="nav-item">
                        <a href=<?= base_url('super-admin/access'); ?>>Menu</a>
                     </li>
                     <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                     </li>
         ...
         elRule.addEventListener("change", () => {
            ...
            swal({
               ...
               if (willChange) {
                  let ress;
                  if (!isSelect)
                     ress = await deleteData(baseUrl + `api/access/menu/${elMenu.value}/${elRule.value}`);
                  else ress = await postData(baseUrl + `api/access/menu`, {
                     menu_id: elMenu.value,
