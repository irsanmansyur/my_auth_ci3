          ...
          <div class="card">
            <div class="card-header  d-flex justify-content-between">
              ...
              <?php if ($this->input->get("menu_id")) : ?>
                <a href="<?= base_url('super-admin/submenu/tambah/' . $this->input->get("menu_id")); ?>" class="btn btn-primary">Tambah</a>
              <?php else :; ?>
                  ...
                  <tbody>
                    ...
                    foreach ($submenus as $key => $sm) : ?>
                      <tr id="<?= $sm->id; ?>">
                        ...
                        <td>
                          <?php if ($this->input->get("menu_id")) : ?>
                            <a href="<?= base_url('super-admin/submenu/edit/' . $sm->id . "?menu_id={$this->input->get("menu_id")}"); ?>" class="btn btn-warning btn-sm rounded">Edit</a>
                          <?php else :; ?>
