        ...
        <div class="page-inner">
          ...
          <div class="card">
            <div class="card-header  d-flex justify-content-between">
              ...
              <a href="<?= base_url('permission/submenu/tambah' . ($menu ? "?menu_id=" . $menu->id  : '')); ?>" class="btn btn-primary">Tambah</a>
            </div>
            <div class="card-body">
                    ...
                    foreach ($submenus as $key => $sm) : ?>
                      <tr id="<?= $sm->id; ?>">
                        ...
                        <td>
                          ...
                          <?php else :; ?>
                            <a href="<?= base_url('permission/access/type/' . $sm->id) . "/submenu"; ?>" class="btn btn-primary btn-sm rounded">Set Access</a>
                          <?php endif; ?>

                        </td>
                        <td>
                          <?php if ($this->input->get("menu_id")) : ?>
                            <a href="<?= base_url('permission/submenu/edit/' . $sm->id . "?menu_id={$this->input->get("menu_id")}"); ?>" class="btn btn-warning btn-sm rounded">Edit</a>
                          <?php else :; ?>
                            <a href="<?= base_url('permission/submenu/edit/' . $sm->id); ?>" class="btn btn-warning btn-sm rounded">Edit</a>
                          <?php endif; ?>

                          <a href="<?= base_url('permission/submenu/delete/' . $sm->id); ?>" class="delete btn btn-danger btn-sm rounded">Delete</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
