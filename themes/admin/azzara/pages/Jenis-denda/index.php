                            ...
                            <div class="table-responsive">
                                <table id="basic-datatables" class="table table-hover display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        foreach ($jenis_denda as $jDenda) : ?>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $jDenda->nama; ?></td>
                                                <td>
                                                    <a href="<?= base_url('admin/denda/jenis/' . $jDenda->id . "/edit"); ?>" class="btn btn-warning btn-sm rounded">Edit</a>
                                                    <a href="<?= base_url('admin/denda/jenis/' . $jDenda->id . "/delete"); ?>" class="delete btn btn-danger btn-sm rounded">Delete</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
