                        ...
                        <form action="" method="post">
                            <div class="card-body">
                                <div class="form-group form-group-default">
                                    ...
                                    <input class="form-control" id="nama" placeholder="Enter name Jenis Denda" name="nama" value="<?= $jenis_denda->nama ?>" />
                                    <?= form_error('nama', '<small class="text-danger">', '</small>'); ?>

                                </div>
                                <div class="form-group form-group-default">
                                    <label for="biaya">Biaya</label>
                                    <input type="number" class="form-control" id="biaya" value="<?= $jenis_denda->biaya; ?>" name="biaya" placeholder="0">
