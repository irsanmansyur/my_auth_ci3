                ...
                <div class="page-inner">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Form input data Mobil</div>
                        </div>
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="name" placeholder="Enter name mobil" name="nama_mobil">
                                </div>
                                <div class="form-group">
                                    <label for="kapasitas">kapasitas</label>
                                    <input class="form-control" id="kapasitas" type="number" placeholder="Enter kapasitas mobil" name="kapasitas_orang">
                                </div>
                                <div class="form-group">
                                    <label for="harga_sewa">Harga sewa</label>
                                    <input class="form-control" id="harga_sewa" type="number" placeholder="Enter harga_sewa mobil" name="harga_sewa">
                                </div>
                                <div class="form-group">
                                    <label for="stok">Stok Mobil</label>
                                    <input class="form-control" id="stok" type="number" placeholder="Enter stok mobil" name="stok">
                                </div>

                                <div class="form-check">
                                    <label>Status</label><br>
                                    <label class="form-radio-label">
                                        <input class="form-radio-input" type="radio" name="status" value="tersedia" checked="">
                                        <span class="form-radio-sign">tersedia</span>
                                    </label>
                                    <label class="form-radio-label ml-3">
                                        <input class="form-radio-input" type="radio" name="status" value="dipinjam">
