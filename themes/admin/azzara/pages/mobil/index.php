                            ...
                            <div class="table-responsive">
                                <table id="basic-datatables" class="table table-hover display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        foreach ($mobils->result_object() as $jenis) : ?>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $jenis->nama_mobil; ?></td>
                                                <td><img src="<?= base_url('assets/mobils/' . $jenis->gambar); ?>" alt="" style="width:100px;height:100px"> </td>
                                                <td>
                                                    <a href="<?= base_url('admin/mobil/edit/' . $jenis->id); ?>" class="btn btn-warning btn-sm rounded">Edit</a>
                                                    <a href="<?= base_url('admin/mobil/delete/' . $jenis->id); ?>" class="delete btn btn-danger btn-sm rounded">Delete</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
