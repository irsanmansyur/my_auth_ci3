    ...
    <div class="d-flex justify-content-between mt-2 pb-2">
      <div class="col-md-6 pl-0">
        ...
        <div class="input-group">
          ...
          <input type="text" value="0" class="form-control rupiah form-lg" id="GrandTotal" readonly="">
        </div>
      </div>
      <div class="col-md-6 pr-0">
        ...
        <div class="input-group">
          ...
          <input type="text" value="0" class="form-control rupiah form-lg" id="jumlah_bayar">
        </div>
      </div>
    </div>
    <div class="d-flex justify-content-between mt-2 pb-2">
      ...
      <div class="col-md-6 pr-0">
        ...
        <p style="color:red;"> * Jika status kredit harap pilih data supplier</p>
      </div>
    </div>
    ...
    <div class="d-flex justify-content-between mt-2 pb-2">
      ...
      <div class="col-md-6 pr-0">
        ...
        <div class="input-group">
          ...
          <input readonly id="kembalian" class="form-control rupiah text-danger font-weight-bold">
        </div>
      </div>
    </div>
    <div class="card">
