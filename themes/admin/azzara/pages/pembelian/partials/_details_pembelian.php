...
<div class="card card-pricing">
  <div class="card-body">
    <ul class="specification-list">
      <li>
        <span class="name-specification">Kode Pembelian</span>
        <span class="status-specification"><?= $pembelian->kode; ?></span>
      </li>
      <li>
        <span class="name-specification">Tanggal</span>
        <span class="status-specification"><?= date("F m Y", strtotime($pembelian->created_at)); ?></span>
      </li>
      <button class="btn btn-primary btn-block"><b><?= rupiah($pembelian->jumlah_bayar); ?></b></button>
    </ul>
    <ul class="list-group shadow">
      <!-- list group item-->
      <?php foreach ($pembelian->barangs as $barang) : ?>
        <div class="d-flex flex-column flex-md-row w-100">
          ...
          <div class="p-0 col-md-7 d-flex flex-md-row justify-content-md-between">
            <div class="media-body col-md-6 order-2 order-md-1 p-md-0 pl-2 py-1 text-left">
              ...
              <h6 class="font-weight-bold my-2"><?= rupiah($barang->pivot->harga_beli); ?> X <?= $barang->pivot->jumlah; ?></h6>
            </div>
          ...
          <div class="align-items-md-start d-flex flex-md-column harga-barang justify-content-between pl-md-4">
            ...
            <span class="font-weight-bold mb-md-auto text-danger"><?= rupiah($barang->pivot->harga_beli *  $barang->pivot->jumlah); ?></span>
          </div>
        </div>
      <?php endforeach; ?>
      <!-- End -->
