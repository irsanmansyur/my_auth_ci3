                ...
                <div class="page-inner">
                    <div class="page-header">
                        ...
                        <ul class="breadcrumbs">
                            ...
                            <li class="nav-item">
                                <a href=<?= base_url('admin/jenis_denda'); ?>>Daftar Denda</a>
                            </li>
                            <li class="separator">
                                <i class="flaticon-right-arrow"></i>
                            </li>
                            <li class="nav-item active">
                                <a href="#">Tambah Denda</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Form Edit data Denda</div>
                        </div>
                                ...
                                <div class="form-group form-group-default">
                                    ...
                                    <select name="jenis_id" class="form-control" id="formGroupDefaultSelect">
                                        <?php foreach ($jenis_denda as $jDenda) : ?>
                                            <option value="<?= $jDenda->id; ?>"><?= $jDenda->nama; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
