                    ...
                    <div class="row mt-3">
                      <div class="col-md-6">
                        <div class="form-group form-group-default">
                          <label>Name</label>
                          <input type="text" class="form-control" name="nama_user" placeholder="Name" value="<?= $user_edit->nama_user; ?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group form-group-default">
                          <label>Username</label>
                          <input type="text" class="form-control" readonly name="username" placeholder="Name" value="<?= $user_edit->username; ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group form-group-default">
                          ...
                          <select class="form-control" id="status" name="status">
                            <option <?= $user_edit->status == 'aktif' ? 'selected' : ''; ?> value="aktif">aktif</option>
                            <option <?= $user_edit->status == 'non aktif' ? 'selected' : ''; ?> value="non aktif">Non Aktif</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group form-group-default">
                          ...
                          <select class="form-control" id=role_id name=role_id>
                            <?php foreach ($roles as $role) : ?>
                              <option <?= $user_edit->role_id == $role->id ? 'selected' : ''; ?> value="<?= $role->id; ?>"><?= $role->name; ?></option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                      </div>
